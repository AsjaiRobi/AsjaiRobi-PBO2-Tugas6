...
public class CekCuaca extends javax.swing.JFrame {
    ...
    private String API_KEY = "fb765bf8ecd58233278a917ecde66d36";
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Banjarmasin", "Banjarbaru", "Kotabaru", " ", " " }));
    ...
    if (!cityInput.isEmpty() && !isCityInFavorites(cityInput)) {
    ...
    private boolean isCityInFavorites(String cityInput) {
